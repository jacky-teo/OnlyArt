...
CREATE TABLE SUBSCRIPTION_LINK(
	CREATORID varchar(64) NOT NULL,
	CONSUMERID varchar(64) NOT NULL,
	CONSUMERTELE varchar(64) NOT NULL,
	CREATED timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	MODIFIED timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	PRIMARY KEY (CREATORID, CONSUMERID)
) ENGINE=InnoDB;

INSERT INTO SUBSCRIPTION_LINK(CREATORID,CONSUMERID, CONSUMERTELE, CREATED,MODIFIED) 
VALUES 
('CR001', 'CON001', '@tinklebell','2020-06-12 02:14:55', '2020-06-12 02:14:55' ),
('CR002', 'CON002', '@hutthutt', '2020-06-12 02:14:55', '2020-06-12 02:14:55');